        ...
        <section class="space-y-4">
          ...
          <div class={previewCardClasses}>
            <div class="grid grid-cols-3 gap-4">
              ...
              <button type="button" class="btn preset-tonal-error">
                Button
              </button>
            ...
            >
              ...
              <article class="space-y-4 p-4">
                ...
                <p class="opacity-60">
                  ...
                  Numquam aspernatur provident eveniet eligendi cumque
                  consequatur tempore sint nisi sapiente. Iste beatae laboriosam
